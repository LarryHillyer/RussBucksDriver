<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="TestDriver.aspx.vb" Inherits="RussBucksDriver.TestDriver" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
    <asp:HyperLink ID="HyperLink10" runat="server" NavigateUrl="~/Administration/CreateLicensee.aspx">Create Licensee</asp:HyperLink>
    <br />
    ...
    <br />
    <asp:HyperLink ID="HyperLink15" runat="server" NavigateUrl="~/Administration/DeletePoolParameters.aspx">Delete Pool Parameters</asp:HyperLink>
    <br />
    ...
    <br />
    <asp:HyperLink ID="HyperLink14" runat="server" NavigateUrl="~/Administration/CreateSportDatesOfTheWeeks.aspx">Create Dates Of The Weeks</asp:HyperLink>
    <br/>
    <asp:HyperLink ID="HyperLink17" runat="server" NavigateUrl="~/Administration/ContinueCronJob.aspx">Continue CronJob</asp:HyperLink>
    <br />
    <br />
